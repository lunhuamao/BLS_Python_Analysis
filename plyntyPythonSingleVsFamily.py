...
for column in rollupNames[1:]:
    cleanPercentagesFamily[column] = round(inclassCleanAveragesFamily[column]/inclassCleanAveragesFamily.iTotalExp,8)
cleanPercentagesFamily['ExpInc'] = round(inclassCleanAveragesFamily['iTotalExp']/inclassCleanAveragesFamily['FINCBTXM'],8)
...
for column in rollupNames[1:]:
    cleanPercentagesSingle[column] = round(inclassCleanAveragesSingle[column]/inclassCleanAveragesSingle.iTotalExp,8)
cleanPercentagesSingle['ExpInc'] = round(inclassCleanAveragesSingle['iTotalExp']/inclassCleanAveragesSingle['FINCBTXM'],8)
# truncate the max ExpInc
